            ...
            <div class="col">
                <div class="container-fluid">
                    <form method="post" action="proses_update.php">
                        ...
                        <input type="hidden" name="id" value="<?php echo $rowData['id']; ?>" disabled>

                        <!-- Tampilkan data yang akan di-update di dalam form -->
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                <label for="operator">Operator:</label>
                                <select id="operator" class="form-control" name="operator" disabled>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" id="server" class="form-control" name="server" value="<?php echo $rowData['server']; ?>" disabled>
                            </div>
                            <div class="form-group col-md-4">
                                <label for="user_ssh">User SSH:</label>
                                <input type="text" id="user_ssh" class="form-control" name="user_ssh" value="<?php echo $rowData['user_ssh']; ?>" disabled>
                            </div>
                        </div>
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control" id="pathlog" name="pathlog" placeholder="/path/to/folder" value="<?php echo $rowData['pathlog']; ?>" disabled>
                            </div>
                            <div class="form-group col-md-4">
                                <label for="logfile">Log File:</label>
                                <input type="text" class="form-control" id="logfile" name="logfile" placeholder="logfile.log" value="<?php echo $rowData['logfile']; ?>" disabled>
                            </div>
                            <div class="form-group col-md-4">
                                <label for="status_err">Status Error:</label>
                                <input type="text" class="form-control" id="status_err" name="status_err" placeholder="RESP: Error/Connection" value="<?php echo $rowData['status_err']; ?>" disabled>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                <label for="service">Services:</label>
                                <select id="service" class="form-control" name="service" disabled>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <select id="vendor" class="form-control" name="vendor" disabled>
                                    <?php
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control" id="url" name="url" placeholder="send_ip_no" value="<?php echo $rowData['url']; ?>" disabled>
                            </div>
                            <div class="form-group col-md-4">
                                <label for="port">Port:</label>
                                <input type="text" class="form-control" id="port" name="port" placeholder="send_port" value="<?php echo $rowData['port']; ?>" disabled>
                            </div>
                            <div class="form-group col-md-4">
                                <label for="fname">Fname:</label>
                                <input type="text" class="form-control" id="fname" name="fname" placeholder="filename" value="<?php echo $rowData['fname']; ?>" disabled>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                <label for="uname">Username:</label>
                                <input type="text" class="form-control" id="uname" name="uname" placeholder="send_username" value="<?php echo $rowData['uname']; ?>" disabled>
                            </div>
                            <div class="form-group col-md-4">
                                <label for="upass">Password:</label>
                                <div class="input-group">
                                    <input type="password" class="form-control" id="upass" name="upass" placeholder="send_password" value="<?php echo $rowData['upass']; ?>" disabled>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                ...
                                <select id="is_active" class="form-control" name="is_active" disabled>
